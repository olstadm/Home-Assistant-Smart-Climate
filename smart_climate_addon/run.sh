...
TAU_HOURS=$(bashio::config 'tau_hours' '2.0')
FORGETTING_FACTOR=$(bashio::config 'forgetting_factor' '0.99')
BIAS=$(bashio::config 'bias' '0.0')
COMFORT_CAP=$(bashio::config 'comfort_cap' '80.0')
HEAT_MIN_F=$(bashio::config 'heat_min_f' '62.0')
K_HEAT=$(bashio::config 'k_heat' '0.5')
K_COOL=$(bashio::config 'k_cool' '-0.5')
RECOMMENDATION_COOLDOWN=$(bashio::config 'recommendation_cooldown' '30.0')
...
export TAU_HOURS
export FORGETTING_FACTOR
export BIAS
export COMFORT_CAP
export HEAT_MIN_F
export K_HEAT
export K_COOL
export RECOMMENDATION_COOLDOWN
export DEBUG_MODE
